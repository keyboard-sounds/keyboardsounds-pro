            ...
            <GlassCard sx={{ marginBottom: "24px" }}>
                ...
                >
                    <Box sx={{ flexGrow: 1 }}>
                        ...
                        >
                            Play the enabled confirmation sound when "Start
                            Keyboard Sounds" is pressed
                        </Typography>
                    </Box>
                    <Switch
                        checked={playEnabledSoundOnStart}
                        onChange={(e) =>
                            setPlayEnabledSoundOnStart(e.target.checked)
                        }
                        sx={greenSwitchStyle}
                    />
                </Box>
