...
import {
  ...
  GetPlayEnabledSoundOnStart,
  SetPlayEnabledSoundOnStart,
  GetStartHidden,
  SetStartHidden,
...
import enabledSoundUrl from "./assets/sounds/enabled.mp3";
import "./App.css";
...
function App() {
  ...
  const [playEnabledSoundOnStart, setPlayEnabledSoundOnStart] = useState(true);
  ...
  useEffect(() => {
    const loadInitialState = async () => {
      try {
        ...
        // Load "play enabled sound on start" preference
        const playEnabledSoundOnStartValue =
          await GetPlayEnabledSoundOnStart();
        setPlayEnabledSoundOnStart(playEnabledSoundOnStartValue);
  ...
  useEffect(() => {
    ...
    if (!isPaused && playEnabledSoundOnStart) {
      const audio = new Audio(enabledSoundUrl);
      void audio.play().catch(() => {});
    }
    pauseSoundPrevRef.current = isPaused;
  }, [isPaused, isLoading, playEnabledSoundOnStart]);
      ...
      case "Settings":
        return (
          <SettingsPage
            ...
            playEnabledSoundOnStart={playEnabledSoundOnStart}
            setPlayEnabledSoundOnStart={async (value) => {
              setPlayEnabledSoundOnStart(value);
              try {
                await SetPlayEnabledSoundOnStart(value);
              } catch (error) {
                console.error(
                  "Failed to set play enabled sound on start preference:",
                  error,
                );
              }
            }}
